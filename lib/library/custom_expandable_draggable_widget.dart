...
/*
  customize 2023.04.20 KY.Jung
  original source : https://github.com/Tughra/draggable_expandable_fab
  why : want to toggle outside of close fab button

  customize 3 items
  1. rename : _ExpandableDraggableFabState --> ExpandableDraggableFabState
  2. rename : _toggle --> toggle
  3. add    : bool get isOpen => _open;
*/

@immutable
class CustomExpandableDraggableFab extends StatefulWidget {
  const CustomExpandableDraggableFab(
      {super.key,
  ...
  @override
  State<CustomExpandableDraggableFab> createState() => CustomExpandableDraggableFabState();
//_ExpandableDraggableFabState createState() => _ExpandableDraggableFabState();
}

class CustomExpandableDraggableFabState extends State<CustomExpandableDraggableFab>
